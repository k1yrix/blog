...
and while `nix-collect-garbage -d` does the job done, but that wipes all previous generations, which creates the problem of having no backup plan when something goes wrong. [panic noises erupts]
